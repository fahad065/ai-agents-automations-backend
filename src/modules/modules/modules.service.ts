...
const SEED_MODULES: Partial<ModuleTemplate>[] = [
...

  {
    ...
    description_ar: 'يجاوب على أسئلة القائمة، ياخذ الحجوزات، ويشارك عروض اليوم — ليل نهار، بالعربي أو الإنجليزي.',
    tagline: 'Never miss a booking or a menu question again',
    tagline_ar: 'ما تفوّتك أي حجز أو سؤال عن القائمة بعد اليوم',
    ...
    heroStats: [
      ...
      { label: 'Setup time', label_ar: 'وقت التفعيل', value: '< 1 day' },
    ],
    features: [
      { icon: '📋', title: 'Menu & allergen Q&A', title_ar: 'أسئلة القائمة والحساسية', description: 'Answers questions about dishes, ingredients and allergens straight from your uploaded menu — no more repeating the same answers to every customer.', description_ar: 'يجاوب على أسئلة الأطباق والمكونات والحساسية مباشرة من القائمة اللي رفعتها — ما تحتاج تكرر نفس الجواب لكل زبون.' },
      { icon: '📅', title: 'Table reservations', title_ar: 'حجز الطاولات', description: 'Takes booking requests directly in the chat and confirms availability, so your host staff isn’t stuck answering the phone during rush hour.', description_ar: 'ياخذ طلبات الحجز مباشرة في المحادثة ويأكد التوفر، عشان موظف الاستقبال ما ينشغل بالرد على التلفون وقت الزحمة.' },
      { icon: '🔥', title: 'Daily specials', title_ar: 'عروض اليوم', description: 'Shares today’s specials and promotions automatically — update once in the dashboard, it goes out everywhere your bot is deployed.', description_ar: 'يشارك عروض اليوم تلقائيًا — حدّثها مرة وحدة من لوحة التحكم وتنعرض في كل مكان مفعّل فيه البوت.' },
      { icon: '💬', title: 'WhatsApp ordering', title_ar: 'الطلب عبر واتساب', description: 'Customers can ask about the menu and place delivery/pickup requests over WhatsApp, the channel they already use.', description_ar: 'الزبائن يقدرون يسألون عن القائمة ويطلبون توصيل أو استلام عبر واتساب، القناة اللي يستخدمونها أصلاً.' },
    ],
    faq: [
      { question: 'Can it take real orders, not just answer questions?', question_ar: 'يقدر ياخذ طلبات حقيقية، مو بس يجاوب على الأسئلة؟', answer: 'The knowledge-base + Q&A flow is live today. Order-taking with kitchen webhook integration is on our roadmap — ask us about early access.', answer_ar: 'قاعدة المعرفة والأسئلة الشائعة شغالة حالياً. أخذ الطلبات مع ربط المطبخ موجود في خطتنا القادمة — تواصل معنا للوصول المبكر.' },
      { question: 'Does it know today’s specials automatically?', question_ar: 'يعرف عروض اليوم تلقائيًا؟', answer: 'You update specials in your dashboard knowledge base and the bot reflects it immediately across every channel.', answer_ar: 'تحدّث العروض في قاعدة المعرفة من لوحة التحكم والبوت ينعكس فورًا في كل القنوات.' },
    ],
  ...
  },
  {
    ...
    description_ar: 'يفرز المشترين والمستأجرين، يحجز مواعيد المعاينة، ويرسل العقارات المتاحة — يلتقط العملاء وقت ما وكلاءك مشغولين.',
    tagline: 'Turn website visitors into qualified viewings',
    tagline_ar: 'حوّل زوار موقعك إلى مواعيد معاينة جاهزة',
    ...
    heroStats: [
      ...
      { label: 'Availability', label_ar: 'التوفر', value: '24/7' },
      { label: 'Languages', label_ar: 'اللغات', value: 'AR + EN' },
      { label: 'Conversion boost', label_ar: 'زيادة التحويل', value: '+40%' },
    ],
    features: [
      { icon: '🎯', title: 'Buyer & renter qualification', title_ar: 'فرز المشترين والمستأجرين', description: 'Asks the right questions — budget, timeline, property type — before a lead ever reaches your agents.', description_ar: 'يسأل الأسئلة الصحيحة — الميزانية، الوقت، نوع العقار — قبل ما العميل يوصل لوكلائك.' },
      { icon: '🏘️', title: 'Listing search', title_ar: 'البحث عن عقارات', description: 'Shares relevant listings straight from your knowledge base based on what the customer is looking for.', description_ar: 'يشارك العقارات المناسبة مباشرة من قاعدة المعرفة حسب اللي يدوّر عليه العميل.' },
      { icon: '📅', title: 'Viewing scheduling', title_ar: 'حجز مواعيد المعاينة', description: 'Books viewing requests directly in the chat so agents follow up with a warm, scheduled lead instead of a cold enquiry.', description_ar: 'يحجز مواعيد المعاينة مباشرة في المحادثة عشان وكلاءك يتابعون عميل جاهز ومحدد الموعد بدل استفسار بارد.' },
      { icon: '📱', title: 'Instagram & WhatsApp capture', title_ar: 'التقاط العملاء من إنستقرام وواتساب', description: 'Catches leads from DMs and WhatsApp enquiries around the clock, not just during office hours.', description_ar: 'يلتقط العملاء من الرسائل الخاصة واستفسارات واتساب على مدار الساعة، مو بس بأوقات الدوام.' },
    ],
    faq: [
      { question: 'Can it sync leads to my CRM?', question_ar: 'يقدر يربط العملاء مع نظام CRM عندي؟', answer: 'Not yet — today it captures and stores every conversation in your dashboard. CRM sync is on our roadmap.', answer_ar: 'مو حالياً — الآن يلتقط ويخزّن كل محادثة في لوحة التحكم عندك. الربط مع CRM موجود في خطتنا القادمة.' },
      { question: 'Does it replace my sales agents?', question_ar: 'يقدر يعوّض عن وكلاء المبيعات عندي؟', answer: 'No — it handles the repetitive qualification work so your agents spend their time closing, not chasing unqualified leads.', answer_ar: 'لا — يتكفّل بعمل الفرز المتكرر عشان وكلاءك يركزون وقتهم على إغلاق الصفقات، مو ملاحقة عملاء غير جاهزين.' },
    ],
  ...
  },
  {
    ...
    name_ar: 'بوت مواعيد العيادة',
    slug: 'clinic-chatbot',
    description: 'Books appointments, sends reminders, and handles clinic FAQs — reducing no-shows and front-desk phone volume.',
    description_ar: 'يحجز المواعيد، يرسل التذكيرات، ويجاوب على أسئلة العيادة الشائعة — يقلل الغياب عن المواعيد وضغط المكالمات على الاستقبال.',
    tagline: 'Fewer no-shows, less phone tag',
    tagline_ar: 'غياب أقل عن المواعيد، مكالمات أقل',
    ...
    heroStats: [
      ...
      { label: 'Languages', label_ar: 'اللغات', value: 'AR + EN' },
      { label: 'Setup time', label_ar: 'وقت التفعيل', value: '< 1 day' },
      { label: 'No-show reduction', label_ar: 'تقليل الغياب', value: 'Fewer calls missed' },
    ],
    features: [
      { icon: '📅', title: 'Appointment booking', title_ar: 'حجز المواعيد', description: 'Handles booking requests directly in the chat, in Arabic or English, without tying up your front desk.', description_ar: 'يتكفّل بطلبات الحجز مباشرة في المحادثة، بالعربي أو الإنجليزي، من دون ما يشغل موظف الاستقبال.' },
      { icon: '❓', title: 'Clinic FAQs', title_ar: 'أسئلة العيادة الشائعة', description: 'Answers common questions about services, pricing and preparation instructions straight from your knowledge base.', description_ar: 'يجاوب على الأسئلة الشائعة عن الخدمات والأسعار وتعليمات التحضير مباشرة من قاعدة المعرفة.' },
      { icon: '🩺', title: 'Service & pricing info', title_ar: 'معلومات الخدمات والأسعار', description: 'Shares up-to-date service and pricing information so patients don’t have to call and wait on hold.', description_ar: 'يشارك أحدث معلومات الخدمات والأسعار عشان المرضى ما يضطرون يتصلون وينتظرون على الخط.' },
      { icon: '🤝', title: 'Human handoff', title_ar: 'تحويل للموظف', description: 'Escalates sensitive or complex questions to a human staff member automatically instead of guessing.', description_ar: 'يحوّل الأسئلة الحساسة أو المعقدة لموظف حقيقي تلقائيًا بدل ما يخمّن الإجابة.' },
    ],
    faq: [
      { question: 'Can it handle medical advice questions?', question_ar: 'يقدر يجاوب على أسئلة استشارة طبية؟', answer: 'No — the bot is constrained to only answer from your knowledge base (services, hours, policies) and hands off anything else to your staff. It never gives medical advice.', answer_ar: 'لا — البوت مقيّد يجاوب بس من قاعدة المعرفة (الخدمات، الدوام، السياسات) وأي شي ثاني يحوّله لموظفك. ما يعطي أي استشارة طبية أبدًا.' },
      { question: 'Does it send appointment reminders automatically?', question_ar: 'يرسل تذكيرات بالمواعيد تلقائيًا؟', answer: 'Proactive reminder messaging is on our roadmap. Today it handles booking requests and FAQs in the conversation itself.', answer_ar: 'إرسال التذكيرات التلقائية موجود في خطتنا القادمة. حاليًا يتكفّل بطلبات الحجز والأسئلة الشائعة داخل المحادثة نفسها.' },
    ],
  ...
  },
  {
    ...
    name_ar: 'بوت دعم المتجر الإلكتروني',
    ...
    description_ar: 'يتابع الطلبات، يتكفّل بالإرجاع، ويجاوب على أسئلة المنتجات فورًا — يقلل تذاكر الدعم ووقت الرد.',
    tagline: 'Instant answers, fewer support tickets',
    tagline_ar: 'ردود فورية، تذاكر دعم أقل',
    ...
    features: [
      { icon: '📦', title: 'Order status Q&A', title_ar: 'أسئلة حالة الطلب', description: 'Answers "where’s my order" style questions instantly from your policies and info, cutting the most common support ticket type.', description_ar: 'يجاوب على أسئلة "وين طلبي" فورًا من سياساتك ومعلوماتك — يقلل أكثر نوع تذاكر دعم شائع.' },
      { icon: '↩️', title: 'Returns & refunds', title_ar: 'الإرجاع والاسترداد', description: 'Walks customers through your return policy and process without a human needing to type the same answer for the hundredth time.', description_ar: 'يشرح للزبون سياسة الإرجاع وخطواتها من دون ما يحتاج موظف يكتب نفس الجواب للمرة المئة.' },
      { icon: '🛒', title: 'Product Q&A', title_ar: 'أسئلة المنتجات', description: 'Answers sizing, materials and availability questions straight from your product knowledge base — before checkout, not after.', description_ar: 'يجاوب على أسئلة المقاسات والخامات والتوفر مباشرة من قاعدة معرفة منتجاتك — قبل الشراء مو بعده.' },
      { icon: '💬', title: 'WhatsApp support', title_ar: 'الدعم عبر واتساب', description: 'Handles support conversations on WhatsApp, where a growing share of your customers already expect to reach you.', description_ar: 'يتكفّل بمحادثات الدعم عبر واتساب، القناة اللي زبائنك يتوقعون التواصل فيها أكثر فأكثر.' },
    ],
    faq: [
      { question: 'Can it check live order status from Shopify/my store?', question_ar: 'يقدر يتحقق من حالة الطلب مباشرة من شوبيفاي أو متجري؟', answer: 'Live order-lookup integration is on our roadmap. Today it answers from your policies and FAQ knowledge base.', answer_ar: 'الربط المباشر لتتبع الطلبات موجود في خطتنا القادمة. حاليًا يجاوب من سياساتك وقاعدة الأسئلة الشائعة.' },
      { question: 'Will it try to answer things outside my knowledge base?', question_ar: 'يحاول يجاوب على أشياء مو موجودة في قاعدة المعرفة؟', answer: 'No — it’s constrained to only answer from what you’ve added. Anything else gets your fallback message instead of a made-up answer.', answer_ar: 'لا — مقيّد يجاوب بس من اللي أضفته. أي شي ثاني ياخذ رسالتك الاحتياطية بدل جواب مختلق.' },
    ],
  ...
  },
  {
    ...
    name_ar: 'بوت عضويات النادي الرياضي',
    slug: 'gym-chatbot',
    ...
    description_ar: 'يشرح باقات العضوية، يحجز تجارب مجانية، ويجاوب على أسئلة الجدول — يحوّل زوار الموقع إلى تسجيلات تجريبية.',
    tagline: 'Turn visitors into trial members, automatically',
    tagline_ar: 'حوّل الزوار إلى أعضاء تجريبيين تلقائيًا',
    ...
    features: [
      { icon: '💳', title: 'Membership plan Q&A', title_ar: 'أسئلة باقات العضوية', description: 'Explains pricing tiers and what’s included in each membership straight from your knowledge base.', description_ar: 'يشرح باقات الأسعار وايش يشمل كل اشتراك مباشرة من قاعدة المعرفة.' },
      { icon: '🎟️', title: 'Free trial booking', title_ar: 'حجز تجربة مجانية', description: 'Books free trial sessions directly in the conversation, capturing interested visitors before they leave your site.', description_ar: 'يحجز حصص تجريبية مجانية مباشرة في المحادثة، ويلتقط الزوار المهتمين قبل ما يغادرون موقعك.' },
      { icon: '🗓️', title: 'Class schedule queries', title_ar: 'أسئلة جدول الحصص', description: 'Answers questions about class times and availability without staff needing to check a spreadsheet.', description_ar: 'يجاوب على أسئلة أوقات الحصص والتوفر من دون ما يحتاج الموظف يرجع لجدول إكسل.' },
      { icon: '💬', title: 'WhatsApp enquiries', title_ar: 'استفسارات عبر واتساب', description: 'Handles membership questions over WhatsApp, where most gym enquiries already happen.', description_ar: 'يتكفّل بأسئلة العضوية عبر واتساب، القناة اللي أغلب استفسارات النادي تصير فيها أصلاً.' },
    ],
    faq: [
      { question: 'Can it book a specific class time slot?', question_ar: 'يقدر يحجز وقت حصة محدد؟', answer: 'It captures the request and preferred time in the conversation today; live calendar-slot booking is on our roadmap.', answer_ar: 'حاليًا يسجل الطلب والوقت المفضل في المحادثة؛ الحجز المباشر بالتقويم موجود في خطتنا القادمة.' },
      { question: 'Does it work for a multi-location gym chain?', question_ar: 'يشتغل لسلسلة نوادي بعدة فروع؟', answer: 'Yes — you can run a separate bot per location, each with its own knowledge base and schedule info, from one dashboard.', answer_ar: 'أكيد — تقدر تشغّل بوت منفصل لكل فرع، كل وحد له قاعدة معرفة وجدول خاص فيه، من نفس لوحة التحكم.' },
    ],
  ...
  },
  {
    ...
    description_ar: 'يرشد الطلاب المحتملين، يجاوب على أسئلة الدورات الشائعة، ويجمع الطلبات — يقلل عبء فريق القبول.',
    tagline: 'Answer every prospective student, instantly',
    tagline_ar: 'جاوب على كل طالب محتمل فورًا',
    ...
    features: [
      { icon: '📚', title: 'Course Q&A', title_ar: 'أسئلة الدورات', description: 'Answers questions about courses, duration and requirements straight from your knowledge base, day or night.', description_ar: 'يجاوب على أسئلة الدورات والمدة والمتطلبات مباشرة من قاعدة المعرفة، ليل نهار.' },
      { icon: '📝', title: 'Admissions FAQs', title_ar: 'أسئلة القبول الشائعة', description: 'Handles the repetitive admissions questions your team answers dozens of times a week.', description_ar: 'يتكفّل بأسئلة القبول المتكررة اللي فريقك يجاوب عليها عشرات المرات كل أسبوع.' },
      { icon: '✅', title: 'Application guidance', title_ar: 'إرشاد التقديم', description: 'Walks prospective students through what’s needed to apply, collecting interest before they lose momentum.', description_ar: 'يوضّح للطالب المحتمل المطلوب للتقديم، ويجمع اهتمامه قبل ما يفقد الحماس.' },
      { icon: '💬', title: 'WhatsApp enquiries', title_ar: 'استفسارات عبر واتساب', description: 'Reaches prospective students on the channel they already use to ask questions.', description_ar: 'يوصل للطلاب المحتملين على القناة اللي يستخدمونها أصلاً للسؤال.' },
    ],
    faq: [
      { question: 'Can it submit applications directly into our system?', question_ar: 'يقدر يرسل الطلبات مباشرة لنظامنا؟', answer: 'Not yet — it collects and stores the enquiry in your dashboard today. Direct application-system integration is on our roadmap.', answer_ar: 'مو حالياً — يجمع ويخزّن الاستفسار في لوحة التحكم عندك. الربط المباشر مع نظام التقديم موجود في خطتنا القادمة.' },
      { question: 'Can different courses have different FAQs?', question_ar: 'يقدر كل دورة تكون لها أسئلة شائعة مختلفة؟', answer: 'Yes — add as much course-specific content to the knowledge base as you need; the bot ranks and answers from the most relevant entries.', answer_ar: 'أكيد — ضيف أي محتوى خاص بكل دورة لقاعدة المعرفة قد ما تحتاج؛ البوت يرتب ويجاوب من الأقرب للسؤال.' },
    ],
    demoVideoUrl: 'https://1ajwuueru6fqolyr.public.blob.vercel-storage.com/chatbot-demos/education-enrolment-bot-demo.mp4',
  },
  {
    name: 'Salon & Spa Booking Bot',
    name_ar: 'بوت حجوزات الصالون والسبا',
    slug: 'salon-chatbot',
    description: 'Answers service and pricing questions, books appointments, and shares availability — cutting phone tag for busy front desks.',
    description_ar: 'يجاوب على أسئلة الخدمات والأسعار، يحجز المواعيد، ويشارك الأوقات المتاحة — يقلل ضغط المكالمات على الاستقبال.',
    tagline: 'Every booking answered, even after closing',
    tagline_ar: 'كل حجز يتجاوب عليه، حتى بعد الدوام',
    moduleType: 'chatbot', category: 'custom', pipelineType: 'custom', outputType: 'text',
    icon: '💇', color: '#ec4899', badge: 'Live', sortOrder: 7,
    isActive: true, isComingSoon: false,
    nicheSlug: 'hospitality', pipelineCategory: 'standalone', availableIn: ['UAE', 'Kenya'],
    requiredApiKeys: ['openai'],
    platforms: ['website', 'whatsapp', 'instagram'],
    capabilities: ['Service & pricing Q&A', 'Appointment booking', 'Stylist availability', 'WhatsApp booking'],
    ...
    features: [
      { icon: '💅', title: 'Service & pricing Q&A', title_ar: 'أسئلة الخدمات والأسعار', description: 'Answers questions about treatments, packages and pricing straight from your knowledge base.', description_ar: 'يجاوب على أسئلة الخدمات والباقات والأسعار مباشرة من قاعدة المعرفة.' },
      { icon: '📅', title: 'Appointment booking', title_ar: 'حجز المواعيد', description: 'Takes booking requests directly in the chat, day or night, without tying up your front desk.', description_ar: 'ياخذ طلبات الحجز مباشرة في المحادثة، ليل نهار، من دون ما يشغل موظف الاستقبال.' },
      { icon: '👩‍🦰', title: 'Stylist / therapist availability', title_ar: 'توفر الأخصائيين', description: 'Shares which staff member is available for the service the customer wants, straight from your info.', description_ar: 'يشارك أي موظف متاح للخدمة اللي يبيها الزبون، مباشرة من معلوماتك.' },
      { icon: '💬', title: 'WhatsApp booking', title_ar: 'الحجز عبر واتساب', description: 'Handles booking conversations on WhatsApp, the channel most salon and spa clients already prefer.', description_ar: 'يتكفّل بمحادثات الحجز عبر واتساب، القناة اللي أغلب عملاء الصالونات والسبا يفضلونها أصلاً.' },
    ],
    faq: [
      { question: 'Can it book a specific stylist or therapist?', question_ar: 'يقدر يحجز موعد مع أخصائي معين؟', answer: 'It captures the preference in the conversation today; live staff-calendar booking is on our roadmap.', answer_ar: 'حاليًا يسجل التفضيل في المحادثة؛ الحجز المباشر بتقويم الموظفين موجود في خطتنا القادمة.' },
      { question: 'Does it work for a multi-branch salon chain?', question_ar: 'يشتغل لسلسلة صالونات بعدة فروع؟', answer: 'Yes — run a separate bot per branch, each with its own knowledge base, from one dashboard.', answer_ar: 'أكيد — شغّل بوت منفصل لكل فرع، كل وحد له قاعدة معرفته الخاصة، من نفس لوحة التحكم.' },
    ],
  },
  {
    name: 'Hotel & Travel Concierge Bot',
    name_ar: 'بوت كونسيرج الفندق والسفر',
    slug: 'hotel-chatbot',
    description: 'Answers reservation, amenity and local-recommendation questions instantly — day or night, before and after check-in.',
    description_ar: 'يجاوب فورًا على أسئلة الحجز والمرافق والتوصيات المحلية — ليل نهار، قبل وبعد تسجيل الوصول.',
    tagline: 'A front desk that never sleeps',
    tagline_ar: 'استقبال ما ينام أبدًا',
    moduleType: 'chatbot', category: 'custom', pipelineType: 'hospitality', outputType: 'text',
    icon: '🏨', color: '#06b6d4', badge: 'Live', sortOrder: 8,
    isActive: true, isComingSoon: false,
    nicheSlug: 'hospitality', pipelineCategory: 'standalone', availableIn: ['UAE', 'Kenya'],
    requiredApiKeys: ['openai'],
    platforms: ['website', 'whatsapp', 'instagram'],
    capabilities: ['Reservation Q&A', 'Amenity info', 'Local recommendations', 'WhatsApp guest support'],
    ...
    features: [
      { icon: '🛎️', title: 'Reservation Q&A', title_ar: 'أسئلة الحجوزات', description: 'Answers availability, room-type and rate questions straight from your knowledge base, before guests ever call.', description_ar: 'يجاوب على أسئلة التوفر ونوع الغرفة والسعر مباشرة من قاعدة المعرفة، قبل ما الضيف يتصل أصلاً.' },
      { icon: '🏊', title: 'Amenity info', title_ar: 'معلومات المرافق', description: 'Shares pool, breakfast, spa and check-in/out times so guests aren’t left waiting on hold.', description_ar: 'يشارك أوقات المسبح والفطور والسبا وتسجيل الدخول والخروج عشان الضيف ما ينتظر على الخط.' },
      { icon: '🗺️', title: 'Local recommendations', title_ar: 'توصيات محلية', description: 'Suggests nearby restaurants and attractions straight from your curated list, adding a concierge touch at scale.', description_ar: 'يقترح مطاعم ومعالم قريبة من قائمتك المختارة، يعطي لمسة كونسيرج بدون جهد إضافي.' },
      { icon: '💬', title: 'WhatsApp guest support', title_ar: 'دعم الضيوف عبر واتساب', description: 'Handles guest questions over WhatsApp before, during and after their stay.', description_ar: 'يتكفّل بأسئلة الضيوف عبر واتساب قبل وأثناء وبعد إقامتهم.' },
    ],
    faq: [
      { question: 'Can it check live room availability from our booking engine?', question_ar: 'يقدر يتحقق من توفر الغرف مباشرة من نظام الحجز عندنا؟', answer: 'Live availability sync is on our roadmap. Today it answers from your rates and policies knowledge base.', answer_ar: 'الربط المباشر للتوفر موجود في خطتنا القادمة. حاليًا يجاوب من قاعدة معرفة الأسعار والسياسات عندك.' },
      { question: 'Can it handle guests in both Arabic and English?', question_ar: 'يقدر يتعامل مع ضيوف بالعربي والإنجليزي؟', answer: 'Yes — it detects and replies in whichever language the guest writes in.', answer_ar: 'أكيد — يكتشف لغة الضيف ويرد بنفس اللغة.' },
    ],
  },
  {
    name: 'Auto Dealership Bot',
    name_ar: 'بوت معرض السيارات',
    slug: 'auto-dealership-chatbot',
    description: 'Answers inventory and financing questions, books test drives, and captures buyer leads — day or night, on the lot or online.',
    description_ar: 'يجاوب على أسئلة المخزون والتمويل، يحجز تجارب القيادة، ويلتقط عملاء مهتمين — ليل نهار، في المعرض أو أونلاين.',
    tagline: 'Never lose a lead after showroom hours',
    tagline_ar: 'ما تخسر أي عميل بعد دوام المعرض',
    moduleType: 'chatbot', category: 'custom', pipelineType: 'custom', outputType: 'text',
    icon: '🚗', color: '#f97316', badge: 'Live', sortOrder: 9,
    isActive: true, isComingSoon: false,
    nicheSlug: 'ecommerce_retail', pipelineCategory: 'standalone', availableIn: ['UAE', 'Kenya'],
    requiredApiKeys: ['openai'],
    platforms: ['website', 'whatsapp', 'instagram'],
    capabilities: ['Inventory Q&A', 'Financing FAQs', 'Test drive booking', 'WhatsApp lead capture'],
    ...
    features: [
      { icon: '🚙', title: 'Inventory Q&A', title_ar: 'أسئلة المخزون', description: 'Answers questions about available models, trims and specs straight from your knowledge base.', description_ar: 'يجاوب على أسئلة الموديلات المتوفرة والفئات والمواصفات مباشرة من قاعدة المعرفة.' },
      { icon: '💳', title: 'Financing FAQs', title_ar: 'أسئلة التمويل الشائعة', description: 'Explains financing options and requirements without a salesperson repeating the same explanation all day.', description_ar: 'يشرح خيارات ومتطلبات التمويل من دون ما يكرر البائع نفس الشرح طول اليوم.' },
      { icon: '🔑', title: 'Test drive booking', title_ar: 'حجز تجربة قيادة', description: 'Books test drive requests directly in the chat, capturing a warm lead before they visit a competitor.', description_ar: 'يحجز طلبات تجربة القيادة مباشرة في المحادثة، يلتقط عميل جاهز قبل ما يروح لمعرض منافس.' },
      { icon: '💬', title: 'WhatsApp lead capture', title_ar: 'التقاط العملاء عبر واتساب', description: 'Catches enquiries from WhatsApp around the clock, not just showroom hours.', description_ar: 'يلتقط الاستفسارات من واتساب على مدار الساعة، مو بس أوقات دوام المعرض.' },
    ],
    faq: [
      { question: 'Can it check live inventory from our system?', question_ar: 'يقدر يتحقق من المخزون مباشرة من نظامنا؟', answer: 'Live inventory sync is on our roadmap. Today it answers from the models and specs you add to its knowledge base.', answer_ar: 'الربط المباشر للمخزون موجود في خطتنا القادمة. حاليًا يجاوب من الموديلات والمواصفات اللي تضيفها لقاعدة المعرفة.' },
      { question: 'Does it replace my sales team?', question_ar: 'يقدر يعوّض عن فريق المبيعات عندي؟', answer: 'No — it handles repetitive inventory and financing questions so your salespeople spend their time closing warm, qualified leads.', answer_ar: 'لا — يتكفّل بأسئلة المخزون والتمويل المتكررة عشان فريق المبيعات يركز وقته على إغلاق صفقات مع عملاء جاهزين.' },
    ],
  },
];
...
export class ModulesService implements OnModuleInit {
  ...
  // reason: the chatbot templates originally shipped English-only (the _ar
  // fields exist on the schema but SEED_MODULES never populated them), and
  // $setOnInsert only reaches brand-new documents, not the ones already
  // sitting in the DB. Gated on name_ar being unset so an admin's manual AR
  // edit from /dashboard/cms-modules is never overwritten.
  private async backfillChatbotArabicContent() {
    const chatbotSeeds = SEED_MODULES.filter((m) => m.moduleType === 'chatbot' && m.name_ar);
    let updated = 0;
    for (const m of chatbotSeeds) {
      const result = await this.moduleModel.updateOne(
        { slug: m.slug, moduleType: 'chatbot', name_ar: { $in: [null, ''] } },
        {
          $set: {
            name_ar: m.name_ar,
            tagline_ar: m.tagline_ar,
            description_ar: m.description_ar,
            capabilities_ar: m.capabilities_ar,
            heroStats: m.heroStats,
            features: m.features,
            faq: m.faq,
            'pricing.features_ar': m.pricing?.features_ar,
            'pricing.customLabel_ar': m.pricing?.customLabel_ar,
          },
        },
      );
      if (result.modifiedCount) updated++;
